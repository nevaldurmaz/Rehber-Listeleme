...
const Modal = ({ isModalOpen, close, setContacts, editItem }) => {
  console.log("düzenlenecek eleman", editItem);
  ...
  const handleSubmit = (e) => {
    ...
    if (!editItem) {
      ...
      axios
        ...
        .then((res) => {
          // state'i güncelle (ara yüze elemanın eklenmesini sağlar)
          setContacts((contacts) => [...contacts, res.data]);
        });
    } else {
      // güncellenecek eleman varsa güncelleme isteği at
      axios
